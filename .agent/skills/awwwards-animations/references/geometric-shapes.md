...
<svg viewBox="0 0 400 400">
  <RegularPolygon sides={3} radius={40} cx={50} cy={50} fill="#ff6b6b" />{" "}
  {/* Triángulo */}
  <RegularPolygon sides={5} radius={40} cx={150} cy={50} fill="#4ecdc4" />{" "}
  {/* Pentágono */}
  <RegularPolygon sides={6} radius={40} cx={250} cy={50} fill="#45b7d1" />{" "}
  {/* Hexágono */}
  <RegularPolygon sides={8} radius={40} cx={350} cy={50} fill="#96ceb4" />{" "}
  {/* Octágono */}
</svg>;
```
