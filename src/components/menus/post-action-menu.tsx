    ...
    <>
      <DropdownMenu>
        ...
        {!isLoggedUser ? (
          <DropdownMenuContent
            align="end"
            className="bg-background shadow-xl dark:bg-[#181818] rounded-2xl w-[190px] mt-1 p-0"
          >
            ...
            <DropdownMenuItem className="focus:bg-transparent px-4 tracking-normal  select-none font-bold py-3 cursor-pointer text-[15px] text-red-700 focus:text-red-700 rounded-none active:bg-primary-foreground">
              Block
            </DropdownMenuItem>
            <DropdownMenuSeparator className=" h-[1.2px] my-0" />
            <DropdownMenuItem className="focus:bg-transparent px-4 tracking-normal select-none font-semibold py-3 cursor-pointer text-[15px] rounded-none active:bg-primary-foreground">
              Hide
            </DropdownMenuItem>
            <DropdownMenuSeparator className=" h-[1.2px] my-0 " />
            <DropdownMenuItem className="focus:bg-transparent px-4 tracking-normal select-none font-bold py-3 cursor-pointer text-[15px] text-red-700 focus:text-red-700 active:bg-primary-foreground rounded-none">
              Report
            </DropdownMenuItem>
          </DropdownMenuContent>
        ) : (
